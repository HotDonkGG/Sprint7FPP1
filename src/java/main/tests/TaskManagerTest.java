...
import java.main.managers.task.TaskManager;
import java.main.model.*;
import java.main.utility.UtilityManagers;
...
public abstract class TaskManagerTest <T extends TaskManager>{
    ...
    public void updateEpicStateToInProgressTest() {
        ...
        var epic1 = manager.addEpic(newEpic());
        var subtask1 = manager.addSubTask(newSubtask(epic1));
        var subtask2 = manager.addSubTask(newSubtask(epic1));
    ...
    public void removeTaskTest() {
        ...
        assertEquals(emptyMap, manager.getAllTask());
